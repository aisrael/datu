...
pub struct ConcatArgs {
    ...
    #[arg(
        ...
        help = "Parquet output compression codec: none, null, snappy, gzip, zstd, brotli, lz4, or lz4_raw (case-insensitive; \"null\" is an alias for \"none\"). Only applies when concatenating to Parquet output. Default: none."
    )]
